...
class FdCounter extends React.PureComponent { 
    ...
    render () { 
        return (
            <View style={[{width: 80, height: theme.size.itemWHeight, borderColor: '#ccc', borderWidth: 0.3, borderRadius: 5, flexDirection: 'row'}, this.style]}>
                <TouchableOpacity style={{flex: 1}} onPress={() => {this._change('sub')}}>
                    <View style={{alignItems: 'center', justifyContent: 'center', flex: 1, borderRightColor: '#ccc', borderRightWidth: 0.3}}><Text style={{color: '#232323'}}> - </Text></View>
                </TouchableOpacity>
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                    <Text style={{color: '#232323'}}>{ this.state.value }</Text>
                </View>
                <TouchableOpacity style={{flex: 1}} onPress={() => {this._change('add')}}>
                    <View style={{alignItems: 'center', justifyContent: 'center', flex: 1, borderLeftColor: '#ccc', borderLeftWidth: 0.3}}><Text style={{color: '#232323'}}> + </Text></View>
                </TouchableOpacity>
            </View>
        )
    }
