...
export default class Scanner extends Component {
    ...
    _renderTitleBar(){
        return(
            <Text style={{color:'white', textAlignVertical:'center', textAlign:'center', font:20, padding:12}}>扫描二维码</Text>
        );
    }
 
    _renderMenu() {
        return (
            <Text style={{color:'white', textAlignVertical:'center', textAlign:'center', font:20, padding:12}}>正在扫描...</Text>
        )
    }
 
    barcodeReceived(e) {
        this.props.event && this.props.event(e)
    }
}
