...
export default class extends Component {
  ...
  render() {
    return (
      <TouchableWithoutFeedback onPress={() => {this.setState({cover: true}); alert(1)}}> 
        <View style={[{width: this.setState.videoWidth, height: this.setState.videoHeight}, this.props.style]}> 
            <Video source={{uri: this.state.value}}   // Can be a URL or a local file.
                ref={(ref) => {}} 
                paused={false} 
                repeat={true}       
                resizeMode={'contain'}                  // Store reference 
                style={[{width: this.setState.videoWidth, height: this.setState.videoHeight}, this.props.style]} 
            /> 
        </View>
    ...
    //             width: this.state.videoWidth,
    //             height: this.state.videoHeight,
    //             backgroundColor: this.state.playing ? 'transparent' : 'rgba(0, 0, 0, 0.2)',
    //             alignItems:'center',
    ...
    //                 source={this.state.playing ? require('../../assets/image/icon_control_pause.png') : require('../../assets/image/icon_control_play.png')}
    //               />
    //             </TouchableOpacity>
